...
<template>
  ...
  >
    ...
    <g v-else-if="name === 'eye-off'">
      <path d="M17.9 17.9A10.7 10.7 0 0 1 12 19c-7 0-11-7-11-7a18.5 18.5 0 0 1 4.1-5.1" />
      <path d="M9.9 4.2A10.7 10.7 0 0 1 12 4c7 0 11 7 11 7a18.6 18.6 0 0 1-3.1 4.1" />
